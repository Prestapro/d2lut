...
_STORMSHIELD_RE = re.compile(r"(?i)\b(?:stormshield|storm\s*shield)\b")  # Removed 'ss' - too many false positives
...
_GRANDFATHER_RE = re.compile(r"(?i)\b(?:grandfather|the\s+grandfather)\b")  # Removed 'gf' - too many false positives
